    ...
    def getForecastAtTime(dateArray, location=""):
        ...
        if (pytools.clock.dateArrayToUTC(pytools.clock.getDateTime()) + 8035200) > pytools.clock.dateArrayToUTC(dateArray):
            if afterData == False:
                ...
                afterData = [[averagePointData["wspd"] / 2, averagePointData["wspd"], 10000, 0, "clear", 0, averagePointData["pres"], averagePointData["temp"], averagePointData["rhum"], averagePointData["wdir"], 0, [0, 0, 0, 0, 0, 0], (averagePointData["cldc"] / 8) * 100], [0, 0, averagePointData["pres"], averagePointData["temp"], averagePointData["rhum"], 0], [averagePointData["temp"], averagePointData["rhum"], averagePointData["pres"], averagePointData["prcp"], averagePointData["wspd"] / 2, averagePointData["wspd"], True], "", [], [], [], [], [], [0, 0, 0, 0], pytools.clock.UTCToDateArray(pytools.clock.dateArrayToUTC([dateArray[0], *dateArray[1:3], dateArray[3] + 1, 0, 0]))]
                ...
                beforeData = [[averagePointData["wspd"] / 2, averagePointData["wspd"], 10000, 0, "clear", 0, averagePointData["pres"], averagePointData["temp"], averagePointData["rhum"], averagePointData["wdir"], 0, [0, 0, 0, 0, 0, 0], (averagePointData["cldc"] / 8) * 100], [0, 0, averagePointData["pres"], averagePointData["temp"], averagePointData["rhum"], 0], [averagePointData["temp"], averagePointData["rhum"], averagePointData["pres"], averagePointData["prcp"], averagePointData["wspd"] / 2, averagePointData["wspd"], True], "", [], [], [], [], [], [0, 0, 0, 0], pytools.clock.UTCToDateArray(pytools.clock.dateArrayToUTC([dateArray[0], *dateArray[1:3], dateArray[3], 0, 0]))]
